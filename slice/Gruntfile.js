module.exports = function(grunt) {
	grunt.initConfig({
		...
		concat: {
			...
			dist: {
				src: ['src/js/globals.js', 'src/js/common.js', 'src/js/carousel.js', 'src/js/scroll.js', 'src/js/form.js', 'src/js/admin-team.js', 'src/js/tabs.js', 'src/js/toogle.js', 'src/js/search.js'],
				dest: 'tmp/main.js'
			}
		},
