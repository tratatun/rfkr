...
class Http extends RequestAbstract
{
    ...
    public function setQuery($spec, $value = null)
    {
        if ((null === $value) && !is_array($spec)) {
            throw new \InvalidArgumentException('Invalid value passed to setQuery(); must be either array of values or key/value pair');
        }
        if ((null === $value) && is_array($spec)) {
    ...
    {
        if ((null === $value) && !is_array($spec)) {
            throw new \InvalidArgumentException('Invalid value passed to setPost(); must be either array of values or key/value pair');
        }
        if ((null === $value) && is_array($spec)) {
            foreach ($spec as $key => $value) {
    ...
    /**
     * Return request data or value of specified request parameter
     *
     * @param null|string $key
     * @param mixed $default
     * @return string
     */
    public function getRequestParam($key = null, $default = null)
    {
        if (is_null($key)) {
            return $_REQUEST;
        }
